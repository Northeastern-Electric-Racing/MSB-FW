...
void vTempMonitor(void *pv_params) {
  can_msg_t temp_sensor_msg = {
      .id = convert_can(CANID_TEMP_SENSOR, device_loc), .len = 4, .data = {0}};
...
void vIMUMonitor(void *pv_params) {
  ...
  can_msg_t imu_accel_msg = {
      .id = convert_can(CANID_IMU_ACCEL, device_loc), .len = 6, .data = {0}};
  can_msg_t imu_gyro_msg = {
      .id = convert_can(CANID_IMU_GYRO, device_loc), .len = 6, .data = {0}};
...
void vTOFMonitor(void *pv_params) {
  can_msg_t range_msg = {
      .id = convert_can(CANID_TOF, device_loc), .len = 4, .data = {0}};
...
void vShockpotMonitor(void *pv_params) {
  can_msg_t shockpot_msg = {
      .id = convert_can(CANID_SHOCK_SENSE, device_loc), .len = 4, .data = {0}};
...
void vStrainMonitor(void *pv_params) {
  can_msg_t strain_msg = {
      .id = convert_can(CANID_STRAIN_SENSE, device_loc), .len = 8, .data = {0}};
